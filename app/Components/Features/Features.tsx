        ...
        <div className="space-y-16 sm:space-y-20 lg:space-y-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="order-2 lg:order-1">
              <div className="bg-[#FBFFEE] rounded-3xl p-6 sm:p-8 lg:p-12 max-w-md mx-auto lg:mx-0">
                <Image
            ...
            <div className="order-1 lg:order-2 text-center lg:text-left">
              ...
              <p className="text-gray-600 text-base sm:text-lg mb-6 sm:mb-8 max-w-lg mx-auto lg:mx-0">
                Every contribution, payout, and withdrawal is logged
                automatically. With Ajo, your full transaction timeline is clear
                and easy to follow — no confusion, no missing funds.
              </p>
              <button className="bg-[#CBEB6D] hover:bg-green-400 text-gray-900 px-6 sm:px-8 py-3 rounded-lg flex items-center gap-2 transition font-medium text-base sm:text-lg mx-auto lg:mx-0">
                Get Ajo App
                <Image
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 sm:mb-6">
                Community-Driven —<br />
                Save with people you
                <br />
                know and trust.
              </h3>
              <p className="text-gray-600 text-base sm:text-lg mb-6 sm:mb-8 max-w-lg mx-auto lg:mx-0">
                Ajo is all about trust and Culture. This feature helps you save
              ...
              <div className="space-y-4 max-w-lg mx-auto lg:mx-0">
                <div className="flex items-center gap-3 justify-center lg:justify-start">
                  <Image
                    ...
                    height={24}
                  />
                  <p className="text-gray-900 text-base sm:text-lg text-left">
            ...
            {/* Image */}
            <div>
            <div className="bg-[#FBFFEE] rounded-3xl p-6 sm:p-8 lg:p-12 max-w-md mx-auto lg:mx-0 lg:ml-auto">
                <Image
